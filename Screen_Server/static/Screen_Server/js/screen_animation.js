document.addEventListener('DOMContentLoaded', () => {
   ...
   function drawLine(stops, lineColor) {
        ...
        // const pointWidth = 10; // Ширина точки
        // const containerPadding = 50; // Отступ между контейнерами
        // const endX = (stops.length - 1) * (containerPadding + pointWidth);
        //
        // console.log(`endX: ${endX}, pointWidth: ${pointWidth}`)
        // progressLine.style.width = `${endX + pointWidth}px`;
        ...
        const finishX = finishRect.left + window.scrollX;

        console.log('finish: ', finishX);
